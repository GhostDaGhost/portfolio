                ...
                <div id='main_inner_centeredarea'>
                    ...
                    <div className='about_page_wrapper'>
                        ...
                        <Typography sx={{ ['mt']: 3, ['mb']: 1 }} variant="body1" component="div">
                            ...
                            The user interfaces' back-end were created in LUA and the front-end were created in Typescript/jQuery/HTML. How FiveM displayed these interfaces was through a system called <a className='hyperlink' href='https://docs.fivem.net/docs/scripting-manual/nui-development/full-screen-nui/'>Fullscreen NUI</a>.
                        </Typography>
                    </div>
                    ...
                    <div className='about_page_wrapper'>
                        ...
                        <Typography sx={{ ['mt']: 3 }} variant="body1" component="div">
                            ...
                            <br></br>
                            <br></br>
                            Originally, <span style={{['color']: 'red'}}>State of Emergency</span> utilized <a className='hyperlink' href='https://gitlab.com/'>GitLab</a> but then moved onto <a className='hyperlink' href='https://github.com/'>GitHub</a> for a more reliable repository system. On both systems,
                            ...
                            I continued doing this for about 5 months before moving onto reviewing existing code written in LUA. I reviewed by cleaning, fixing bugs and reducing redundancy/optimizing. Due to the age of this written code,
